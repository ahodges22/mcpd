...
## Purpose
Define cross-platform user-session supervision that restarts mcpd, delivers declaration-referenced credentials, binds startup to the credential-bearing session, and documents verification boundaries.
