# client-wiring Specification

## Purpose
Define safe preview, installation, and surgical reversion when rewiring supported coding clients to mcpd while preserving approvals and unrelated configuration.
