# loopback-security Specification

## Purpose
Define the local HTTP security boundary through loopback binding, shared cross-origin protection, guarded mutations, escaped backend output, and an explicit threat model.
